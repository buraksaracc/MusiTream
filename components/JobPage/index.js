    ...
    <View style={styles.container}>
      ...
      <View style={styles.profileBorder}>
        ...
        <View style={styles.info}>
          ...
          <Text style={styles.employertype}>Owner of Bitirmece Discord Channel</Text>
        </View>
        <View>
        ...
        <Text
          ...
          >
            DUTIES: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec a
            commodo odio. Vestibulum condimentum at arcu non cursus.
          </Text>
          
          <TouchableOpacity style={styles.apply} >
          
          <Ionicons name="play" size={70} color="#7B61FF">
